    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-background p-4">
            <div className="w-full max-w-sm border-2 border-foreground">
                ...
                {/* Body */}
                <div className="p-8">
                    <p className="text-xs text-muted-foreground text-center mb-6 normal-case tracking-normal font-normal">
                        Sign in with your Google account to create, manage, and send certificates.
                    </p>
                    <Button
                        onClick={login}
                        size="lg"
                        className="w-full h-11 font-bold uppercase tracking-widest text-xs gap-3 border-2"
                    >
